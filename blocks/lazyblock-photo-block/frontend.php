...
add_filter('lazyblock/gcod-photo-block/frontend_callback', 'gcod_photo_block_output_fe', 10, 2);

if (!function_exists('gcod_photo_block_output_fe')) :
    /**
     ...
     */
    function gcod_photo_block_output_fe($output, $attributes) {
        ob_start();
?>

        <?php if (isset($attributes['image']['url'])) : ?>
            <h3>This is Front End</h3>
            <p>
